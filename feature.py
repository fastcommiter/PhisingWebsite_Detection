...
class FeatureExtraction:
    ...
    def __init__(self, url):
        ...
        try:
            ...
            # FIX: was response.text (module) instead of self.response.text
    ...
    def RequestURL(self):
        try:
            i, success = 0, 0
            # FIX: was missing i, success initialization
    ...
    def AnchorURL(self):
        try:
            i, unsafe = 0, 0
            # FIX: was using module-level `url` instead of self.url
    ...
    def InfoEmail(self):
        try:
            # FIX: was self.soap (typo) and wrong regex pattern
    ...
    def AbnormalURL(self):
        try:
            # FIX: original logic was wrong (comparing response.text to whois object)
            # Correct: check if hostname exists in URL
    ...
    def WebsiteTraffic(self):
        try:
            # FIX: was using module-level `url` variable instead of self.url
            rank = BeautifulSoup(
    ...
    def PageRank(self):
        try:
            # FIX: was using rank_checker_response param instead of the actual response variable
